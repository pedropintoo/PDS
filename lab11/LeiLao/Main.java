...
public class Main {
    public static void main(String[] args) {
        ...
        Product product1 = new Product("Produto 1", 10);
        Product product2 = new Product("Produto 2", 4);
        Product product3 = new Product("Produto 3", 50);
        Product product4 = new Product("Produto 4", 30);
        Product product5 = new Product("Produto 5", 20);
        ...
        client1.bid(product1, 31);
        client2.bid(product1, 33);
        client1.bid(product1, 35);
        client4.bid(product1, 45);
        auctionHouse.pushAuction(5, 5);
